...
export function useTabLayoutClasses() {
  ...
  return {
    tabsListClass: isMobile 
      ...
      : 'inline-flex justify-between w-full bg-secondary/50 p-1.5 rounded-xl',
    tabTriggerClass: isMobile 
      ...
      : 'flex-1 px-4 h-10 rounded-lg transition-all data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:shadow-sm font-medium text-base'
  }
}
