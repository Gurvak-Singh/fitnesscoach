...
import { ArrowRight, Target, Utensils, Dumbbell, LineChart, ShoppingCart } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      ...
      <section className="container mx-auto px-4 pt-16 pb-20 md:pt-24 md:pb-32">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mb-6 text-4xl font-bold tracking-tight md:text-6xl">
            <span className="text-primary">Fit</span>Meal Tracker
          </h1>
      ...
      <section className="bg-secondary/30 py-16">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-center text-3xl font-bold">How FitMeal Helps You</h2>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg bg-card p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <h3 className="mb-2 text-xl font-semibold">Workout Tracking</h3>
              <p className="text-muted-foreground">
                Follow customized workout plans based on your BMI and goals. Track your progress and stay
                motivated.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-card p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Visualize your fitness journey with comprehensive analytics and progress graphs to stay
                motivated.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-card p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <h3 className="mb-2 text-xl font-semibold">BMI Calculator</h3>
              <p className="text-muted-foreground">
                Calculate your Body Mass Index to better understand your current fitness status and set
                realistic goals.
              </p>
            </div>
          </div>
